...
# I/O
out_dir = 'tokenizer_low_measures_fix_subset_BPMProbe'
eval_interval = 5000
...
def get_batch(split='train', batch_size=batch_size):
    ...
    meta = torch.from_numpy(np.stack([data[idx:idx+n_chunks] for idx in idxs], axis=0)).pin_memory().to(device, non_blocking=True)
