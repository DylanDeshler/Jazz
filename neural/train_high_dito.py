...
model_args = dict(z_shape=(256, 50), n_residual_layers=2, lstm=0, transformer=2, dimension=256, n_filters=32, ratios=[8, 5, 5, 4, 2], dilation_base=3, down_proj=None, c0=192, c1=384, c2=768)
