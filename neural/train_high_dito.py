...
model_args = dict(z_shape=(256, 50), n_residual_layers=3, lstm=0, transformer=1, dimension=256, n_filters=32, ratios=[8, 4, 4, 4, 2, 2], channels=[128, 256, 512, 512, 1024, 1024], dilation_base=3, down_proj=1024)
