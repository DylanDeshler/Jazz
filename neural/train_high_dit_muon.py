...
model_args = dict(max_input_size=max_seq_len, local_window=1, in_channels=vae_embed_dim, conditional=False)
...
# optimizer
optimizer = raw_model.model.configure_muon(muon_lr, adam_lr, (beta1, beta2), weight_decay, ddp_local_rank, ddp_world_size)
