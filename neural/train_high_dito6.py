...
model_args = dict(z_shape=(128, 50), n_residual_layers=3, lstm=0, transformer=1, dimension=128, n_filters=24, ratios=[8, 4, 4, 4, 2, 2, 2], channels=[64, 128, 128, 256, 256, 512, 512], dilation_base=3, down_proj=1024, max_channels=2048)
