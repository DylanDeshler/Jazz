...
model_args = dict(z_shape=(16, 32), in_dim=1, hidden_dim=384, latent_dim=16, n_heads=6, encoder_depth=4, encoder_n_interleave=3, decoder_depth=8, decoder_n_interleave=2, n_latents=32, kernel_size=7)
