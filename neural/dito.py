...
class DiToV6(nn.Module):
    def __init__(self, z_shape, in_dim, hidden_dim, latent_dim, n_heads, depth, n_interleave, n_latents, kernel_size):
        ...
        self.decoder = Reciever(in_dim=in_dim, hidden_dim=hidden_dim, latent_dim=latent_dim, n_heads=n_heads, depth=depth, n_interleave=n_interleave, n_latents=n_latents, window_size=None, kernel_size=kernel_size)
