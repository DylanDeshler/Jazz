...
batch_size = 2 * 12# * 5 * 8 # if gradient_accumulation_steps > 1, this is the micro-batch size
block_size = 256
# model
rate = 16000
n_samples = rate * 1
...
# model init
model_args = dict(n_layers=n_layer, n_heads=n_head, dim=n_embd, max_seq_len=block_size, vocab_size=meta_vocab_size, dropout=dropout, 
                  rate=rate, n_fft=n_fft, hop_length=hop_length, win_length=win_length, patch_height=patch_height, patch_width=patch_width) # start with model_args from command line
