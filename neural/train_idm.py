...
# I/O
out_dir = 'RawIDM_delta_measures_bpm_B_RFSQ_64codes_3quants'
eval_interval = 5000
...
warmup_iters = 210000 # how many steps to warm up for
...
def generate_lam_vs_random_actions(step):
    ...
    for i in range(20):
        ...
        # axes.ravel()[4].set_ylim(0, 10000) # Show up to 10kHz
